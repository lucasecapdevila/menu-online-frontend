...
export const getItemsByCategory = async (categoryName: string): Promise<ProcessedMenuItem[]> => {
...
export const getItemById = async (id: string): Promise<ProcessedMenuItem | null> => {
